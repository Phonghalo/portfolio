...
export const SamePage = ({container}:{container: React.MutableRefObject<HTMLDivElement | null>}) => {
    ...
    <section ref={targetRef}>
      <div className="relative h-[800vh]">
        <div className="sticky top-1/2 flex origin-center -translate-y-1/2 justify-center">
          ...
          >
            <img className="h-auto w-full" src="/main-screen.svg" />
            <motion.img
            ...
            />
            <motion.span className="mt-3 block text-2xl text-white" style={{ opacity: newBranchOpacity }}>
              Feature branch
            </motion.span>
          </motion.div>
          <motion.div
          ...
          >
            ...
            <motion.div style={{ opacity: newBranchOpacity }} className="absolute inset-0">
